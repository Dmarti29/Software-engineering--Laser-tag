...
echo "1. Start backend (in one terminal): in same directory    python3 -m backend.server"
echo "2. Start frontend (in another terminal): in same directory  python3 main.py"
echo ""
